 ...
 * 
 * @author allen
 * @version $Id: DefaultByteArraySerializationObjectInput.java, v 0.1 2016年3月2日 下午5:12:23 allen Exp $
 */
public class DefaultByteArraySerializationObjectInput implements ObjectInput {
     ...
     * @throws IOException
     */
    public DefaultByteArraySerializationObjectInput(InputStream is) throws IOException {
    ...
    public String readUTF() throws IOException {
        throw new UnsupportedOperationException("Read string not supported");
    }
