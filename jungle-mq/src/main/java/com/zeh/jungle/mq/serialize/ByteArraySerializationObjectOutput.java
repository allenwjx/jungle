 ...
 */
public class ByteArraySerializationObjectOutput implements ObjectOutput {
    /***/
     ...
     * @throws IOException
     */
    public ByteArraySerializationObjectOutput(OutputStream os) throws IOException {
     ...
     * @param out
     */
    protected ByteArraySerializationObjectOutput(ObjectOutputStream out) {
