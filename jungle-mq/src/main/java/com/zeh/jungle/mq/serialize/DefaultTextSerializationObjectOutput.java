 ...
 * 
 * @author allen
 * @version $Id: DefaultTextSerializationObjectOutput.java, v 0.1 2016年3月2日 下午5:11:37 allen Exp $
 */
public class DefaultTextSerializationObjectOutput implements ObjectOutput {
    /***/
     ...
     * @throws IOException
     */
    public DefaultTextSerializationObjectOutput(OutputStream os) throws IOException {
