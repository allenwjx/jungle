 ...
 * 
 * @author allen
 * @version $Id: ByteArraySerialization.java, v 0.1 2016年3月2日 下午5:09:55 allen Exp $
 */
public class ByteArraySerialization implements Serialization {
    ...
    public ObjectOutput serialize(URL url, OutputStream output) throws IOException {
        return new ByteArraySerializationObjectOutput(output);
    }
    ...
    public ObjectInput deserialize(URL url, InputStream input) throws IOException {
        return new ByteArraySerializationObjectInput(input);
    }
