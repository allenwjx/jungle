...
<sqlMap>
    ...
    <resultMap id="${resultMap.name}" class="${tableConfig.basepackage}.dataobject.${tableConfig.className}${deployModule}DO">
    ...
    <resultMap id="RM.${tableConfig.className}" class="${tableConfig.basepackage}.dataobject.${tableConfig.className}${deployModule}DO">
