...
var Layout = function () {
    ...
    var handleSidebarToggler = function () {
        var body = $('body');
        if (window.localStorage.sidebarClosed == 1 && Metronic.getViewPort().width >= resBreakpointMd) {
            $('body').addClass('page-sidebar-closed');
            $('.page-sidebar-menu').addClass('page-sidebar-menu-closed');
        }

        if (window.localStorage.sidebarClosed == 0) {
            if (body.hasClass("page-sidebar-closed")) {
        ...
        $('body').on('click', '.sidebar-toggler', function (e) {
            ...
            if (body.hasClass("page-sidebar-closed")) {
                ...
                if (window.localStorage) {
                    window.localStorage.sidebarClosed = 0;
                }
            } else {
                body.addClass("page-sidebar-closed");
                ...
                if (window.localStorage) {
                    window.localStorage.sidebarClosed = 1;
                }
            }
            //侧边栏滚动条处理
            //侧边栏滚动条处理
